        ...
        <div className="row gy-4 align-items-start">
          ...
          <div className="col-12 col-md-2 d-flex flex-column align-items-center text-center">
            ...
            <div className="d-flex gap-2 mt-2">
              ...
              <a href="https://www.facebook.com" target="_blank" rel="noopener noreferrer" className="btn p-2" style={{ color: '#2D5A27' }} aria-label="Facebook">
                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" viewBox="0 0 16 16">
                  <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z" />
                </svg>
              </a>
              <a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer" className="btn p-2" style={{ color: '#2D5A27' }} aria-label="Instagram">
                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" viewBox="0 0 16 16">
          ...
          <div className="col-6 col-sm-4 col-md-2 col-lg-2">
            ...
            <div className="d-flex flex-column gap-1">
              ...
              <Link to="/nosotros" className="text-decoration-none small" style={{ color: '#2D5A27' }}>Nosotros</Link>
              <Link to="/contacto" className="text-decoration-none small" style={{ color: '#2D5A27' }}>Contacto</Link>
            </div>
          </div>
